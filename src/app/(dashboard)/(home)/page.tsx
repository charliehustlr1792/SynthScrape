...
import { GetStatsCardsValue } from '../../../../actions/analytics/getStatsCardsValues';
...
const HomePage
 = ({searchParams}:{searchParams:{month?:string;
  year?:string
 }}) => {
  ...
  return (
    <div className='flex flex-1 flex-col h-full'>
      <div className='flex justify-between'>
        <h1 className='text-3xl font-bol'>Home</h1>
...
async function CreditsUsageInPeriod({selectedPeriod}:{selectedPeriod:Period}){
  ...
  return <CreditsUsageChart data={data} title="Daily credits spent" description="Daily credit consumed in selected period"/>
}
